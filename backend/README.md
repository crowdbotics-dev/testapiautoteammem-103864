...
## Project Structure
    ...
    ├── testapiautoteammem_103864  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_103864`
...
2. Clone this repo and `cd testapiautoteammem_103864`
